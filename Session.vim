...
set shortmess=aoO
badd +71 config/application.rb
badd +9 app/controllers/application_controller.rb
badd +0 app/controllers/pgcs_controller.rb
badd +2 app/models/empresa.rb
badd +49 app/models/user.rb
badd +1 app/controllers/users_controller.rb
badd +2 app/models/pgc.rb
badd +22 app/controllers/empreses_controller.rb
badd +6 app/models/habilitacio.rb
badd +14 app/controllers/comptabilitat_controller.rb
badd +13 app/controllers/assentaments_controller.rb
badd +0 app/controllers/home_controller.rb
badd +29 app/controllers/assistits_controller.rb
badd +139 app/models/assentament.rb
badd +0 config/routes.rb
badd +17 app/models/historial.rb
silent! argdel *
...
exe '2resize ' . ((&lines * 15 + 22) / 44)
exe 'vert 2resize ' . ((&columns * 83 + 84) / 168)
exe '3resize ' . ((&lines * 25 + 22) / 44)
...
silent! normal! zE
let s:l = 75 - ((40 * winheight(0) + 20) / 41)
...
wincmd w
argglobal
edit app/controllers/empreses_controller.rb
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> gf <Plug>RailsTabFind
nmap <buffer> f <Plug>RailsSplitFind
...
setlocal numberwidth=4
setlocal omnifunc=
setlocal path=.,~/dev/assets,~/dev/assets/app,~/dev/assets/app/models,~/dev/assets/app/controllers,~/dev/assets/app/helpers,~/dev/assets/config,~/dev/assets/lib,~/dev/assets/app/views,~/dev/assets/app/views/empreses,~/dev/assets/public,~/dev/assets/test,~/dev/assets/test/unit,~/dev/assets/test/functional,~/dev/assets/test/integration,~/dev/assets/spec,~/dev/assets/spec/models,~/dev/assets/spec/controllers,~/dev/assets/spec/helpers,~/dev/assets/spec/views,~/dev/assets/spec/lib,~/dev/assets/spec/requests,~/dev/assets/spec/integration,~/dev/assets/app/*,~/dev/assets/vendor,~/dev/assets/vendor/plugins/*/lib,~/dev/assets/vendor/plugins/*/test,~/dev/assets/vendor/rails/*/lib,~/dev/assets/vendor/rails/*/test,/usr/include,
setlocal nopreserveindent
setlocal nopreviewwindow
setlocal quoteescape=\\
setlocal noreadonly
