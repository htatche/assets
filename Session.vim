...
badd +87 app/controllers/assistits_controller.rb
...
badd +2 app/views/assistits/_show.html.erb
...
badd +141 app/assets/javascripts/historials.js
badd +3 app/views/assistits/_frm_p3_alta.html.erb
badd +44 app/assets/javascripts/application.js
badd +8 app/assets/javascripts/tabs.js
badd +100 app/assets/stylesheets/assistits.css
badd +61 app/assets/stylesheets/historials.css
badd +13 app/models/assentament.rb
...
badd +45 app/assets/stylesheets/application.css
badd +10 app/assets/javascripts/assentaments.js
badd +395 app/assets/javascripts/pgc.js
badd +67 app/views/assistits/_new.html.erb
...
badd +9 app/assets/javascripts/menu.js
badd +0 app/assets/stylesheets/menu.css
badd +0 app/assets/javascripts/home.js
silent! argdel *
...
silent! normal! zE
let s:l = 153 - ((37 * winheight(0) + 28) / 56)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 26 - ((9 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
26
...
exe 'vert 1resize ' . ((&columns * 78 + 78) / 157)
exe 'vert 2resize ' . ((&columns * 78 + 78) / 157)
tabedit app/assets/stylesheets/menu.css
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
exe 'vert 1resize ' . ((&columns * 78 + 78) / 157)
exe 'vert 2resize ' . ((&columns * 78 + 78) / 157)
tabedit app/assets/javascripts/home.js
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
edit app/assets/javascripts/menu.js
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> gf <Plug>RailsTabFind
nmap <buffer> f <Plug>RailsSplitFind
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 34 - ((25 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
34
